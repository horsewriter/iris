...
import { EmployeeDashboard } from '@/components/dashboards/employee-incident-dashboard'
import { HrDashboard } from '@/components/hr/hr-incident-dashboard'
import { HighPositionDashboard } from '@/components/dashboards/highposition-incident-dashboard'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      <main className="py-8 relative z-10">
        ...
        {role === Role.HR && <HrDashboard />}
        {isHighPosition(role) && <HighPositionDashboard />}
