...
export default function PayrollDashboardPage() {
  ...
  useEffect(() => {
    ...
    // Only allow HR and Admin access to payroll
    if (session && ![Role.ADMIN, Role.HR].includes(session.user.role as Role)) {
  ...
  if (!session || ![Role.ADMIN, Role.HR].includes(session.user.role as Role)) return null
